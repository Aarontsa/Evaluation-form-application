...
import my.com.bbraun.hrit.EvaluationForm.FeedbackFormSupervisorDAO;
...
public class FeedbackFormSupervisorServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public FeedbackFormSupervisorServlet() {
		super();
	}
...
//			 System.out.println(clean_d2);
			 ...
			 FeedbackFormSupervisorBean bean = new FeedbackFormSupervisorBean();
			 bean.SetQ1(Q1);
			 bean.SetQ1_1(Q1_1);
			 bean.SetQ1_2(Q1_2);
			 bean.SetQ1_3(Q1_3);
...
//			 bean.SetData14(clean_courseTitleID);
			...
			/*** Pass the bean to DAO for processing ***/
			 bean = FeedbackFormSupervisorDAO.selectQuery(bean);
