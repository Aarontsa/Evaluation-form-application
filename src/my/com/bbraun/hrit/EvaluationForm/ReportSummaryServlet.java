...
import my.com.bbraun.hrit.EvaluationForm.ReportSummaryDAO;
//import my.com.bbraun.hrit.EvaluationForm.ReportSummaryBean;
...
public class ReportSummaryServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String bean = ReportSummaryDAO.getReportSummaryDetails();
